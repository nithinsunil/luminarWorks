...
let countryArray = [] // creating an array to store final output
...
for (let country of countries) {
  ...
  let countryData = { countryName, countryCapital, countryPopulation, countryCurrency }
...
// let myCountry = countryArray.find(coun => coun.countryName == "India")
// console.log(myCountry);

// let chinaCurrency = countryArray.find(china => china.countryName == "China").countryCurrency
// console.log(chinaCurrency);

let populatedCountry = countryArray.filter(count => count.population > 20000000).forEach(count => console.log(count.countryName);)
